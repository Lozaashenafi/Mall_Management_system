/*
  ...
  - You are about to drop the column `type` on the `utilitycharge` table. All the data in the column will be lost.
  - You are about to drop the column `type` on the `utilityexpense` table. All the data in the column will be lost.
  - Added the required column `utilityTypeId` to the `UtilityCharge` table without a default value. This is not possible if the table is not empty.
  - Added the required column `utilityTypeId` to the `UtilityExpense` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE `invoice` ADD COLUMN `pdfUrl` VARCHAR(191) NULL;

-- AlterTable
ALTER TABLE `utilitycharge` DROP COLUMN `type`,
    ADD COLUMN `utilityTypeId` INTEGER NOT NULL;

-- AlterTable
ALTER TABLE `utilityexpense` DROP COLUMN `type`,
    ADD COLUMN `utilityTypeId` INTEGER NOT NULL;
