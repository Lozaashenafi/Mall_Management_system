/*
  ...
  - You are about to drop the column `adminNote` on the `maintenanceschedule` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE `maintenanceschedule` DROP COLUMN `adminNote`;

-- AlterTable
ALTER TABLE `maintenancescheduleoccurrence` ADD COLUMN `adminNote` VARCHAR(191) NULL;
