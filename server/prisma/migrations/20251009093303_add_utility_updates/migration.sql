...
-- AlterTable
ALTER TABLE `rental` ADD COLUMN `includeGenerator` BOOLEAN NOT NULL DEFAULT true,
    ADD COLUMN `includeService` BOOLEAN NOT NULL DEFAULT true,
    ADD COLUMN `includeWater` BOOLEAN NOT NULL DEFAULT true,
    ADD COLUMN `selfManagedElectricity` BOOLEAN NOT NULL DEFAULT false,
    ADD COLUMN `utilityShare` DOUBLE NULL;

-- AlterTable
ALTER TABLE `utilitycharge` MODIFY `type` ENUM('Generator', 'Water', 'Electricity', 'Service', 'Other') NOT NULL;
...
CREATE TABLE `UtilityExpense` (
    ...
    `type` ENUM('Generator', 'Water', 'Electricity', 'Service', 'Other') NOT NULL,
