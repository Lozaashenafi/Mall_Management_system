...
-- AlterTable
ALTER TABLE `notification` MODIFY `type` ENUM('Invoice', 'Maintenance', 'PaymentReminder', 'RenewalReminder', 'OverduePayment', 'PaymentConfirmation', 'PaymentDeclined', 'PaymentRequest', 'UtilityAlert', 'SystemAlert') NOT NULL;
