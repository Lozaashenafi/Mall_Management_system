/*
  ...
  - You are about to drop the column `utilityInvoiceId` on the `paymentrequest` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE `paymentrequest` DROP COLUMN `utilityInvoiceId`,
    ADD COLUMN `account` VARCHAR(191) NULL,
    ADD COLUMN `bankAccountId` INTEGER NULL,
    ADD COLUMN `name` VARCHAR(191) NULL;

-- AlterTable
ALTER TABLE `utilityinvoice` ADD COLUMN `paymentRequestId` INTEGER NULL;
