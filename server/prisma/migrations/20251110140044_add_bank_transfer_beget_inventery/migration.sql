...
-- AlterTable
ALTER TABLE `invoice` ADD COLUMN `withholdingAmount` DOUBLE NULL,
    ADD COLUMN `withholdingRate` DOUBLE NULL;

-- AlterTable
ALTER TABLE `rental` ADD COLUMN `includeTax` BOOLEAN NOT NULL DEFAULT true;

-- AlterTable
ALTER TABLE `room` ADD COLUMN `roomPrice` INTEGER NOT NULL;
