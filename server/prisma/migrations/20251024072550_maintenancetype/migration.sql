...
-- AlterTable
ALTER TABLE `notification` MODIFY `type` ENUM('Invoice', 'Maintenance', 'PaymentReminder', 'RenewalReminder', 'OverduePayment', 'PaymentConfirmation', 'UtilityAlert', 'SystemAlert') NOT NULL;
