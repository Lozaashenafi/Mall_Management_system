/*
  ...
  - You are about to drop the column `categoryId` on the `maintenanceschedule` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE `maintenanceschedule` DROP COLUMN `categoryId`,
