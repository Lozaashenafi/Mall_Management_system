...
-- AlterTable
ALTER TABLE `invoice` ADD COLUMN `isOverdue` BOOLEAN NULL DEFAULT false,
    ADD COLUMN `lastCheckedAt` DATETIME(3) NULL,
    ADD COLUMN `overdueDays` INTEGER NULL DEFAULT 0,
    ADD COLUMN `overdueSince` DATETIME(3) NULL,
    ADD COLUMN `warningSent` BOOLEAN NULL DEFAULT false;

-- AlterTable
ALTER TABLE `tenant` ADD COLUMN `hasOverdueRent` BOOLEAN NOT NULL DEFAULT false,
    ADD COLUMN `lastOverdueDate` DATETIME(3) NULL,
    ADD COLUMN `overdueCount` INTEGER NOT NULL DEFAULT 0,
    ADD COLUMN `totalOverdueAmount` DOUBLE NOT NULL DEFAULT 0;
