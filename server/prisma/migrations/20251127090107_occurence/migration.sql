/*
  ...
  - You are about to drop the column `recurrenceRule` on the `maintenanceschedule` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE `maintenanceschedule` DROP COLUMN `recurrenceRule`,
    DROP COLUMN `status`;
