...
-- AlterTable
ALTER TABLE `notification` MODIFY `type` ENUM('Invoice', 'Maintenance', 'PaymentReminder', 'RenewalReminder', 'OverduePayment', 'PaymentConfirmation', 'PaymentDeclined', 'PaymentRequest', 'UtilityAlert', 'SystemAlert', 'ExitRequestSubmitted', 'ExitRequestApproved', 'ExitRequestRejected', 'ExitRequestVerified', 'ExitRequestBlocked') NOT NULL;

-- AlterTable
ALTER TABLE `user` MODIFY `role` ENUM('SuperAdmin', 'Admin', 'Tenant', 'SecurityOfficer') NOT NULL;
