/*
  ...
  - A unique constraint covering the columns `[previousRentId]` on the table `Rental` will be added. If there are existing duplicate values, this will fail.
...
-- AlterTable
ALTER TABLE `rental` ADD COLUMN `previousRentId` INTEGER NULL;

-- CreateIndex
CREATE UNIQUE INDEX `Rental_previousRentId_key` ON `Rental`(`previousRentId`);
